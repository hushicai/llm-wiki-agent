---
name: wiki-query
description: "Query the wiki for knowledge. Triggers: 'what do I know about', 'search wiki', 'find', 'query', 'tell me about', 'summarize', 'compare', or any question that should be answered from wiki content."
---
